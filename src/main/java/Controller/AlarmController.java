...
public class AlarmController {
    ...
    private void sendSMS() {
        ...
        String secretKey = "mUjLDNBOujULHMp5heWfENrsE9e15Bg9CJhwq0rD";  // 2차 인증을 위해 서비스마다 할당되는 service secret key	// Service Key : https://www.ncloud.com/mypage/manage/info > 인증키 관리 > Access Key ID
        String serviceId = "ncp:sms:kr:292282224416:moneyexchange";       // 프로젝트에 할당된 SMS 서비스 ID							// service ID : https://console.ncloud.com/sens/project > Simple & ... > Project > 서비스 ID
        ...
        toJson.put("to","01093171207");						// Mandatory(필수), messages.to	수신번호, -를 제외한 숫자만 입력 가능
        toArr.add(toJson);
